...
data={'Shanghai':393,'Shanxi':340,'Sichuan':239,'Guangdong':216,'Zhejiang':192,'Henan':112,'Beijing':92,'Jiangsu':68,
         'Shandong':64,'Guangxi':42,'Liaoning':40,'Anhui':26,'Hunan':24,'Yunnan':19,'Fujian':18,'Guizhou':16,'Chongqing':14,
         'Hubei':13,'Jiangxi':12,'Hebei':11,'Shanxi':10,'Heilongjiang':8,'Tianjin':5,'Hainan':5,'Xinjiang Uygur':3,'Nei Mongol':3,'Jilin':3,
         'Gansu':1,'Xizang':1,'Qinghai':1,'Xianggang':1,}
C2E={'Shanghai':"上海",'Shanxi':"陕西",'Sichuan':"四川",'Guangdong':"广东",'Zhejiang':"浙江",'Henan':"河南",'Beijing':"北京",'Jiangsu':"江苏",
...
for info,shap in zip(m.china_info,m.china):
    proid=info['NAME_1']
    if proid in data:
        poly=Polygon(shap,facecolor='yellow',edgecolor='c',alpha=data[proid]/393)     #给省份添加颜色
        ax.add_patch(poly)
